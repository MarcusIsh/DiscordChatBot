...
//                            console.log(Object.keys(body).length);
                ...
                break;
            case 'csrRank' :
                var users = "SELECT ranking.points as tierPoints, tierRanking.points as rankPoints, SUM(tierPoints + rankPoints) as totalPoints, users.tier, users.rank, users.summonerName FROM users LEFT JOIN ranking ON users.tier = ranking.color LEFT JOIN tierRanking ON users.rank = tierRanking.rankNumber order BY ranking.points desc";
